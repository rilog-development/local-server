...
module.exports = {
  ...
  cors: {
    origins: [
      // frontend origins allowed to POST events
      "http://localhost:3000",
      "http://localhost:5173",
    ],
  },
...
rilog.init({
  config: {
    localServer: {
      ...
      params: {
        // optional key-value pairs saved with every batch
...
See full rilog-lib documentation [here](https://www.npmjs.com/package/@rilog-development/rilog-lib)
...
const rl = createInterface({
  input: createReadStream("logs/my-app/2025-05-15.log.ndjson"),
});
