      ...
      <div className="flex items-center justify-between mb-3 flex-wrap gap-2">
        <div className="flex items-center gap-4 text-sm text-gray-500 dark:text-gray-400 flex-wrap">
          ...
          <span className="relative group flex items-center gap-1 cursor-default">
            ...
            <span className="pointer-events-none absolute bottom-full left-0 mb-2 w-64 rounded-lg bg-gray-900 px-3 py-2 text-xs text-gray-200 shadow-lg opacity-0 group-hover:opacity-100 transition-opacity z-50 leading-relaxed">
              {t.batchesHint}
